...
CvPoint2D32f m_LeftEyeCenterEstymation;
CvPoint2D32f m_RightEyeCenterEstymation;
...
public:
	...
	list<shared_ptr<CTrackingFuture>> m_vLeftEyeFutures;
	list<shared_ptr<CTrackingFuture>> m_vRightEyeFutures;
