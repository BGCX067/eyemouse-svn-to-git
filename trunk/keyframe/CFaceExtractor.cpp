...
void CFaceExtractor::FindFactialFuters()
{
	...
	if ( m_bFaceIsDetected)
		cvRectangle( img, cvPoint(m_FaceRect.x,m_FaceRect.y) ,cvPoint(m_FaceRect.x +m_FaceRect.width  ,m_FaceRect.y +m_FaceRect.height), CV_RGB(222,222,222));

	if ( m_bLeftEyeIsDetected)
		cvRectangle( img, cvPoint(m_LeftEyeRect.x,m_LeftEyeRect.y) ,cvPoint(m_LeftEyeRect.x +m_LeftEyeRect.width ,m_LeftEyeRect.y +m_LeftEyeRect.height), CV_RGB(222,222,222));

	if ( m_bRightEyeIsDetected)
		cvRectangle( img, cvPoint(m_RightEyeRect.x,m_RightEyeRect.y) ,cvPoint(m_RightEyeRect.x +m_RightEyeRect.width ,m_RightEyeRect.y +m_RightEyeRect.height), CV_RGB(222,222,222));
