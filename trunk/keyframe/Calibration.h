...
public:
	...
	if (m_CurrentPointIndex >= m_CalibrationScreenPointsCount)
			return point;
		
		/*if (m_MoveBeetwenPoints)
		{
			point.x = g_CalibrationScreenPoints[m_CurrentPointIndex].x + (g_CalibrationScreenPoints[m_CurrentPointIndex + 1].x - g_CalibrationScreenPoints[m_CurrentPointIndex ].x) *m_CurrentSampleNr/m_SampleCountPerPoint;
			point.y = g_CalibrationScreenPoints[m_CurrentPointIndex].y + (g_CalibrationScreenPoints[m_CurrentPointIndex + 1].y - g_CalibrationScreenPoints[m_CurrentPointIndex ].y)	*m_CurrentSampleNr/m_SampleCountPerPoint;
		}
		else
		{
			point.x = g_CalibrationScreenPoints[m_CurrentPointIndex].x ;
			point.y = g_CalibrationScreenPoints[m_CurrentPointIndex].y ;
